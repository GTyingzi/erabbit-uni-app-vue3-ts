...
onReady(() => {
  ...
  pageInstance.animate(
    '.navbar',
    [{ backgroundColor: 'transparent' }, { backgroundColor: 'The #f8f8f8' }],
    1000,
    { scrollSouce: '#scroller', TimeRanges: 1000, startScrolloffset: 0, endScrollOffset: 252 },
  )
})
      ...
      <view class="goods">
        ...
        <view class="total">
          ...
          <view class="row">
            ...
            <view class="symbol primary">{{ order.countdown }}</view>
          </view>
        </view>
      </view>
